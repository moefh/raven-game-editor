...
pub fn get_asset_type_image(asset_type: DataAssetType) -> ImageRef {
    match asset_type {
        ...
        DataAssetType::World => IMAGE_REFS.world,
        ...
        DataAssetType::TileAnimation => IMAGE_REFS.tile_anim,
...
image_table! {
    ...
    pencil_para: "../../assets/PencilParaIcon.png",
    ...
    layer_para: "../../assets/ParallaxIcon.png",
