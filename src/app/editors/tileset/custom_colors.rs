...
impl CustomColors {
    pub fn get_grid_color(&self) -> Option<egui::Color32> {
        if self.use_grid_color {
            Some(self.grid_color)
        } else {
            None
        }
    }

    pub fn get_bg_color(&self) -> Option<egui::Color32> {
...
impl CustomColorsDialog {
    pub fn new() -> Self {
        CustomColorsDialog {
            open: false,
            dlg_id: egui::Id::new("dlg_tileset_custom_colors"),
            dlg_grid_id: egui::Id::new("dlg_tileset_custom_colors_grid"),
            changed: false,
        }
    }
