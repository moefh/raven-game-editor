...
impl AboutDialog {
    ...
    pub fn show(&mut self, ui: &mut egui::Ui, wt: &mut AppWindowTracker, sys_dialogs: &SysDialogs) {
        ...
        if create_dialog_window(sys_dialogs, ui, self.id, Self::WINDOW_WIDTH, "About", |ui| {
            ui.place(egui::Rect::from_min_size(ui.cursor().min + egui::Vec2::new(16.0, 12.0), Self::ICON_SIZE),
