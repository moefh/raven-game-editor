...
impl TransposeDialog {
    ...
    pub fn new() -> Self {
        TransposeDialog {
            open: false,
            transpose_amount: 0,
            note_filter_cmp: NoteFilter::All,
            note_filter_note: 0,
    ...
    pub fn set_open(&mut self, wc: &mut WindowContext, _mod_data: &ModData) {
        self.note_filter_cmp = NoteFilter::All;
    ...
    fn filter_cell(&self, cell: ModCell, filter_period: u16, filter_sample: u8) -> bool {
        ...
        match self.sample_filter_cmp {
            ...
            SampleFilter::Sample => if cell.sample != filter_sample { return false; }
            _ => {}
        }
        true
    }
    ...
    fn confirm(&mut self, mod_data: &mut ModData) {
        ...
        for cell in mod_data.pattern.iter_mut() {
            if self.filter_cell(*cell, filter_period, self.sample_filter_sample) {
                        ...
                        .show(ui, |ui| {
                            ...
                            ui.horizontal(|ui| {
                                egui::ComboBox::from_id_salt(format!("editor_panel_{}_transp_filter_note_cmp", mod_data.asset.id))
                                    ...
                                    .show_ui(ui, |ui| {
                                        ui.selectable_value(&mut self.note_filter_cmp, NoteFilter::All,       NoteFilter::All.text());
                                ...
                                ui.scope_builder(Self::visibility_ui_builder(self.note_filter_cmp != NoteFilter::All), |ui| {
